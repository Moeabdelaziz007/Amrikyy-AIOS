...
const appIcons: Record<AppID, React.FC<{className: string}>> = {
  ...
  pricing: PricingIcon,
  // FIX: Add missing docsViewer to the appIcons map.
  docsViewer: DocsIcon,
};
