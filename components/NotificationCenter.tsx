...
/**
 * Defines styling and icon configurations for different notification types.
 */
...
/**
 * The NotificationCenter component displays transient "toast" notifications
 * that appear at the top-right of the screen and automatically dismiss.
 * @returns {JSX.Element} The NotificationCenter component.
 */
export const NotificationCenter: React.FC = () => {
    const { toastNotifications } = useNotification();

    return (
        <div className="fixed top-4 right-4 z-[100] w-full max-w-sm space-y-3" aria-live="polite" aria-atomic="true">
                ...
                return (
                    ...
                    >
                        <div className={`flex-shrink-0 size-8 rounded-full flex items-center justify-center ${style.classes}`}>
                            <span className="material-symbols-outlined text-xl" aria-hidden="true">{style.icon}</span>
                        </div>
